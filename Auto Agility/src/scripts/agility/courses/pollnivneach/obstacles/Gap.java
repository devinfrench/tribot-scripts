...
public class Gap extends Obstacle {
    ...
    private static final RSArea GAP_AREA = new RSArea(
        new RSTile(3360, 2979, 1),
        new RSTile(3362, 2977, 1)
    );
    private static final RSTile SUCCESS_TILE = new RSTile(3366, 2976, 1);

    public Gap() {
        super(14938, new RSTile(3363, 2976, 1), "Gap", "Leap", GAP_AREA);
    }
